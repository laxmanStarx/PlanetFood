...
router.get("/restaurants/:id/ratings", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
...
router.post("/ratings", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const restaurant = yield prisma.restaurant.findUnique({ where: { id: restaurantId } });
        if (!restaurant) {
