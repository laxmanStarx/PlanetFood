...
{showMenu && (
  <div className="lg:hidden mt-3 space-y-2">
    ...
    {/* Admin notifications link (mobile) - ADD THIS */}
    {user?.role === "admin" && (
      <button
        onClick={() => {
    ...
    {user ? (
      <>
        ...
        <button 
          ...
          className="block w-full text-center px-2 py-1 bg-red-400 text-white rounded-md"
        >
          Logout
        </button>
      </>
      ...
      <button 
        ...
        className="block w-full text-center px-2 py-1 bg-blue-500 text-white rounded"
      >
        Login
      </button>
    )}
